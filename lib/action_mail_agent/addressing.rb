...
module ActionMailAgent
  ...
  module Addressing
    ...
    # The address alone — "Dana <Dana@Example.com>" and "Dana@Example.com"
    # both come back as "dana@example.com". Mail hands over bare addresses
    # from To/From; forwarders' Delivered-To headers do not always oblige.
    # @return [String] downcased, without display name or brackets
    def normalize(address)
      address = address.to_s
      address = Regexp.last_match(1) if address =~ /<([^>]*)>/
